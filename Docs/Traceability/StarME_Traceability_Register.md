...
| Deploy-01 | Private server deployment | Non-root API image and PostgreSQL/Redis/API/RQ Compose topology | Configuration review; SSH port check | Both supplied IPs reachable on port 22; SSH username/matching private key and DNS/TLS details pending |
