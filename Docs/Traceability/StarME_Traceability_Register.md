...
| Android-01 | Android application | Tester gate, bearer session, remote consent/order/status/first-look/revocation and signed URL integration | Kotlin compile, 2 contract tests, lint, debug APK assembly, install and cold-launch check on Realme RMX3782 | HTTPS build installed and launched; functional device workflow pending Legal consent version/tester session |
